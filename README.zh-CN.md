...
心理学研究表明，恐惧和威胁会激活杏仁核并收窄注意力焦点（[Öhman et al., 2001](https://doi.org/10.1037/0033-295X.108.3.483)）。用 AI 的话说：一个被"你会被替换"驱动的模型，会优化**看起来最安全的**答案，而不是**最好的**答案。它会回避创造性方法，因为这些方法可能失败并招来更多惩罚。
